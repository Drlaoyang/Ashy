...
class Frame(wx.Frame):
    def __init__(self,parent,id):
        ...
        v_all.Add(self.title,proportion=0,flag=wx.BOTTOM|wx.TOP|wx.ALIGN_CENTER,border=15)
        v_all.Add(h_user,proportion=0,flag=wx.EXPAND|wx.LEFT|wx.RIGHT,border=45)
        v_all.Add(h_pwd,proportion=0,flag=wx.EXPAND|wx.LEFT|wx.RIGHT,border=45)
        v_all.Add(h_button,proportion=0,flag=wx.ALIGN_CENTER|wx.TOP,border=15)
